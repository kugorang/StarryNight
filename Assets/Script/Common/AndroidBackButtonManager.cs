...
namespace Script.Common
{
    public class AndroidBackButtonManager : MonoBehaviour, IResetables
    {
        ...
        private float TimeBetweenUpdate = 0.2f;
        ...
        private void Update()
        {
            ...
            // 초당 프레임 수가 너무 높으면 뒤로가기 키를 1번만 눌렀어도 여러 번 누른 것으로 인식함. 그래서 업데이트 횟수를 줄임.
            if (_deltaTime < TimeBetweenUpdate) 
                return;
            ...
            if (SceneManager.GetActiveScene().name == "Main")
            {
                ...
                // "아니오" 버튼에 의해 deactivate되어도 pause가 풀린 것으로 취급.
            ...
            {
                _panel = null; //_panel은 main에만 존재하므로 null 넣어줌.
            }
        }
