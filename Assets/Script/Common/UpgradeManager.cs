                ...
                else
                {
                    ...
                    switch (i)
                    {
                        ...
                        case 1:
                            ...
                            break;
                        case 2:
                            str = "아이템 타이머1 시간 감소 " + _dataController.CoolTimeReduction(0) + "초 -> " +
                                  nextUpgradeValue + "초";
                            break;
                        case 3:
                            str = "아이템 타이머1에서 좋은 아이템 나올 확률 증가 +" + _dataController.BetterItemProb(0) + "% -> +" +
                                  nextUpgradeValue + "%";
                            break;
                        case 4:
                            ...
                            break;
                        case 5:
                            str = "아이템 타이머2 시간 감소 " + _dataController.CoolTimeReduction(1) + "초 -> " +
                                  nextUpgradeValue + "초";
                            break;
                        case 6:
                            str = "아이템 타이머2에서 좋은 아이템 나올 확률 증가 +" + _dataController.BetterItemProb(1) + "% -> +" +
                                  nextUpgradeValue + "%";
                            break;
                        case 7:
                            str = "지구본에서 한 단계 상위 아이템 나올 확률 증가" + DataController.AtlasItemProb + "% -> +" +
                                  nextUpgradeValue + "%";
                            break;
                        case 8:
                            ...
                            break;
                        case 9:
                            str = "아이템 타이머3 시간 감소 " + _dataController.CoolTimeReduction(2) + "초 -> " +
                                  nextUpgradeValue + "초";
                            break;
                        case 10:
                            str = "아이템 타이머3에서 좋은 아이템 나올 확률 증가 +" + _dataController.BetterItemProb(2) + "% -> +" +
                                  nextUpgradeValue + "%";
                            break;
                        // 최종 업그레이드
                        default:
