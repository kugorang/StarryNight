...
namespace Script.Common
{
    ...
    public class DataDictionary : MonoBehaviour
    {
                ...
                switch (fileType)
                {
                    ...
                    case Fileinfo.Questtable:
                        ...
                        if (wordList[1] != formerSceneName) // 씬의 첫 퀘스트의 인덱스 구하기
                        {
                            ...
                            if (formerSceneName != "") LastQuestsOfScene.Add(formerIndex);
            ...
            foreach (var setItemInfo in SetCombineList)
                if (key == setItemInfo.Index1)
                {
                    if (haveDic.ContainsKey(setItemInfo.Index2) && haveDic[setItemInfo.Index2].Count > 0
                                                                ...
                                                                haveDic[setItemInfo.Index3].Count > 0
                                                                && haveDic.ContainsKey(setItemInfo.Index4) &&
                                                                haveDic[setItemInfo.Index4].Count > 0)
                        return setItemInfo;
                }
                ...
                {
                    if (haveDic.ContainsKey(setItemInfo.Index1) && haveDic[setItemInfo.Index1].Count > 0
                                                                && haveDic.ContainsKey(setItemInfo.Index2) &&
                                                                haveDic[setItemInfo.Index2].Count > 0
                                                                && haveDic.ContainsKey(setItemInfo.Index4) &&
                                                                haveDic[setItemInfo.Index4].Count > 0)
                        return setItemInfo;
                }
        ...
        /// <returns></returns>
        public static ItemGroup IndexToGroup(int index)
        {
