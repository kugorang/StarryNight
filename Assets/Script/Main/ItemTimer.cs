...
namespace Script.Main
{
    public class ItemTimer : MonoBehaviour, IResetables
    {
        ...
        {
            // LeftTimer1, LeftTimer2, LeftTimer3 이므로 index+1
            get { return PlayerPrefs.GetFloat("LeftTimer" + (Index + 1), Cooltime); }
            set { PlayerPrefs.SetFloat("LeftTimer" + (Index + 1), value); }
        }
        ...
        private static DateTime LastPlayDate
        {
            get
            {
                return !PlayerPrefs.HasKey("Time")
                    ? DateTime.Now
                    : DateTime.FromBinary(Convert.ToInt64(PlayerPrefs.GetString("Time")));
            }
        }
        ...
        private void Start()
        {
            ...
            _reducedCooltime = Cooltime - _dataController.CoolTimeReduction(Index) * DataController.TwiceAll;
